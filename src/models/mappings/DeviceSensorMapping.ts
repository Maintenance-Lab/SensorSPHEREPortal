...
DeviceSensorMapping.init({
    ...
    model: { type: DataTypes.INTEGER, primaryKey: true, references: { model: 'Sensor', key: 'model'}, allowNull: false},
    manufacturerName: {type: DataTypes.STRING, primaryKey: true, references: { model: 'Sensor', key: 'manufacturerName'}, allowNull: false },
